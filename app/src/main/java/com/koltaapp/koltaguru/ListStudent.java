...
public class ListStudent {
    ...
    public ListStudent(String nama, String nim, String url_photo_profile, String prodi, String email_address, String username) {
        this.nama = nama;
        this.nim = nim;
    ...
    public ListStudent(String nama, String nim, String url_photo_profile) {
        this.nama = nama;
        this.nim = nim;
        this.url_photo_profile = url_photo_profile;
    }
